...
begin try
	begin tran
		...
		CREATE TABLE #drop(script NVARCHAR(MAX))
		CREATE TABLE #create (script NVARCHAR(MAX))
  
		-- drop is easy, just build a simple concatenated list from sys.foreign_keys:
		INSERT INTO #drop(script)
		...
		-- =====================
		insert into dbo.DimDate ([Date], [FullDateAlternateKey]) select -1, '19000101'
...
select name
from sys.columns C
where object_id = (select object_id from sys.objects where name = 'DimDate')
...
---------- 
UPDATE DimDate
SET NgayTao = GETDATE(), NgayCapNhat = GETDATE();

--- 
SELECT * FROM DimDate;
/*
	INSERT DATA FOR DimDate_02
*/
DELETE FROM DimDate_02;

--USE AdventureWorksDW2012
--GO
--SELECT *
--FROM DimDate
--WHERE FullDateAlternateKey >= '2009-01-01' AND  FullDateAlternateKey < '2010-01-01';
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091001,'2009-10-01',5,'Thursday',1,274,40,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091002,'2009-10-02',6,'Friday',2,275,40,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091003,'2009-10-03',7,'Saturday',3,276,40,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091004,'2009-10-04',1,'Sunday',4,277,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091005,'2009-10-05',2,'Monday',5,278,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091006,'2009-10-06',3,'Tuesday',6,279,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091007,'2009-10-07',4,'Wednesday',7,280,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091008,'2009-10-08',5,'Thursday',8,281,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091009,'2009-10-09',6,'Friday',9,282,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091010,'2009-10-10',7,'Saturday',10,283,41,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091011,'2009-10-11',1,'Sunday',11,284,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091012,'2009-10-12',2,'Monday',12,285,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091013,'2009-10-13',3,'Tuesday',13,286,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091014,'2009-10-14',4,'Wednesday',14,287,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091015,'2009-10-15',5,'Thursday',15,288,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091016,'2009-10-16',6,'Friday',16,289,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091017,'2009-10-17',7,'Saturday',17,290,42,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091018,'2009-10-18',1,'Sunday',18,291,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091019,'2009-10-19',2,'Monday',19,292,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091020,'2009-10-20',3,'Tuesday',20,293,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091021,'2009-10-21',4,'Wednesday',21,294,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091022,'2009-10-22',5,'Thursday',22,295,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091023,'2009-10-23',6,'Friday',23,296,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091024,'2009-10-24',7,'Saturday',24,297,43,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091025,'2009-10-25',1,'Sunday',25,298,44,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091026,'2009-10-26',2,'Monday',26,299,44,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091027,'2009-10-27',3,'Tuesday',27,300,44,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091028,'2009-10-28',4,'Wednesday',28,301,44,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091029,'2009-10-29',5,'Thursday',29,302,44,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091030,'2009-10-30',6,'Friday',30,303,44,'October',10,4,2009,2,2,2010,1);
INSERT INTO DimDate_02(DateKey,FullDateAlternateKey,DayNumberOfWeek,EnglishDayNameOfWeek,DayNumberOfMonth,DayNumberOfYear,WeekNumberOfYear,EnglishMonthName,MonthNumberOfYear,CalendarQuarter,CalendarYear,CalendarSemester,FiscalQuarter,FiscalYear,FiscalSemester) VALUES (20091031,'2009-10-31',7,'Saturday',31,304,44,'October',10,4,2009,2,2,2010,1);