...
ADD CONSTRAINT [PK_KhachHangWebTower] 
...
ALTER TABLE [dbo].[HoaDon_WebTower9]
ADD CONSTRAINT [PK_HoaDon_WebTower9] 
...
ALTER TABLE [dbo].[ChiTietHoaDon_WebTower9]
ADD CONSTRAINT [PK_CTHDWebTower] 
PRIMARY KEY CLUSTERED ([MaChiTiet])
WITH (
  PAD_INDEX = OFF,
  IGNORE_DUP_KEY = OFF,
  STATISTICS_NORECOMPUTE = OFF,
...
ALTER TABLE ChiTietHoaDon_WebTower9
ADD FOREIGN KEY (MaHD) REFERENCES HoaDon_WebTower9(MaHD);

ALTER TABLE HoaDon_WebTower9
ADD FOREIGN KEY (MaKH) REFERENCES KhachHang_WebTower9(MaKH);