...
ALTER TABLE [dbo].[ChiTietHoaDon_Jade]
...
ALTER TABLE ChiTietHoaDon_Jade
ADD FOREIGN KEY (MaHD) REFERENCES HoaDon_Jade(MaHD);

ALTER TABLE HoaDon_Jade
ADD FOREIGN KEY (MaKH) REFERENCES KhachHang_Jade(MaKH);